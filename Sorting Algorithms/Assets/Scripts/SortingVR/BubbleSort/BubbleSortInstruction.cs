...
public class BubbleSortInstruction : InstructionDoubleElement {
    ...
    */
    ...
    public override string DebugInfo()
    {
        switch (instruction)
        {
            case UtilSort.COMPARE_START_INST: return base.DebugInfo() + ": [" + value1 + "] ? [" + value2 + "] ::: [" + sortingElementID1 + " | " + holderID1 + "] ? [" + sortingElementID2 + " | " + HolderID2 + "], C=" + isCompare + ", S=" + isSorted;
            case UtilSort.SWITCH_INST: return base.DebugInfo() + ": [" + value1 + "] <--> [" + value2 + "] ::: [" + sortingElementID1 + " | " + holderID1 + "] <--> [" + sortingElementID2 + " | " + HolderID2 + "], C=" + isCompare + ", S=" + isSorted;
            case UtilSort.COMPARE_END_INST: return base.DebugInfo() + ": [" + value1 + "] < [" + value2 + "] ::: [" + sortingElementID1 + " | " + holderID1 + "] | [" + sortingElementID2 + " | " + HolderID2 + "], C=" + isCompare + ", S=" + isSorted;
