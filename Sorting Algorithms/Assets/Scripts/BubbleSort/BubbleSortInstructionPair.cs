...
public class BubbleSortInstructionPair : MonoBehaviour { //InstructionBase {

    /* -------------------------------------------- Instruction class for user test -------------------------------------------- * Not used
    ...
    */
    ...
    public BubbleSortInstructionPair(int seID1, int seID2, int hID1, int hID2, int value1, int value2, string instruction, bool isCompare, bool isSorted)
